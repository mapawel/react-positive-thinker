    ...
    >
      <Grid item xs={12} md={10} lg={6} className={classes.insideBox}>
        ...
        <Image
          ...
          color="transparent"
          imageStyle={{
            backgroundColor: 'transparent', width: 'auto', height: 'auto', maxHeight: '100%', maxWidth: '100%', left: '50%', top: '50%', transform: 'translate(-50%, -50%)',
          }}
...
ImageOpen.propTypes = {
  openImageUrl: PropTypes.string.isRequired,
  handleClickImageClose: PropTypes.func.isRequired,
};
